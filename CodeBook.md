...
* Finally, `averages_data` contains the relevant averages which will be later stored in a `tidydata.txt` file. `ddply()` from the plyr package is used to apply `colMeans()` and ease the development.
